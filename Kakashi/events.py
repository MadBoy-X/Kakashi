...
def load_module(shortname):
    if shortname.startswith("__"):
        ...
        import importlib
        import Kakashi.events

        path = Path(f"Kakashi/modules/{shortname}.py")
        name = "Kakashi.modules.{}".format(shortname)
        ...
        spec.loader.exec_module(mod)
        sys.modules["Kakashi.modules." + shortname] = mod
        print("Successfully imported " + shortname)


path = "Kakashi/modules/*.py"
